...
/** @file log.c
 * @brief The log element.
 * 
 * This file implements everything needed for logging: the log element and its functions.
 *
 * @author Navit Team
 * @date 2005-2010
 */
 ...
 *
 * This function examines the {@code filename} member of {@code log} and replaces any placeholders
